    ...
    "Map",
      ...
      absolutePanel(
        ...
        tags$h4('IDN Information'),
          ...
          div(style = 'width: 100%; float:left', tags$h5('Name: '),tags$h5('This is the name')),
          div(style = 'width: 50%; height: 50; float:left', tags$h5('Income: '),tags$h5('TEST')),
          div(style = 'width: 50%; height: 50; float:left', tags$h5('Income: '),tags$h5('TEST2')),
          div(style = 'width: 50%; float:left', tags$h5('Income: '),tags$h5('')),
          div(style = 'width: 50%; float:left', tags$h5('Income: '),tags$h5('')),
          div(style = 'width: 50%; float:left', tags$h5('Income: '),tags$h5('')),
          div(style = 'width: 50%; float:left', tags$h5('Income: '),tags$h5('')),
          div(style = 'width: 50%; float:left', tags$h5('Income: '),tags$h5('')),
